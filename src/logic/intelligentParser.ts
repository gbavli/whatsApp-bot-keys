...
function findBestMake(input: string, availableMakes: string[]): { make: string; score: number } {
...
function findBestModel(input: string, availableModels: string[]): { model: string; score: number } {
  const normalizedInput = input.toLowerCase().trim();
