// WhatsApp bot with database diagnostics
require('dotenv/config');

console.log('🔍 DIAGNOSTIC MODE - WhatsApp Bot with PostgreSQL');
...
async function runDiagnostics() {
  try {
    ...
    if (!process.env.DATABASE_URL || !process.env.DATABASE_URL.trim()) {
      console.error('❌ DATABASE_URL not found! Make sure PostgreSQL service is connected.');
      process.exit(1);
    }
    ...
    console.log('🔍 Testing vehicle count query...');
